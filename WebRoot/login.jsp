<%@ page language="java" contentType="text/html; charset=UTF-8" import="stu.model.*,java.net.*" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
<head>
<%
...
.labelError{line-height: 9px; font-size: 10pt; color: #f40000; border: 1px #ffb8b8 solid; padding: 8px 8px 8px 35px; background: url(/xjtustus/images/error.png) no-repeat; background-color: #fef2f2;}
</style>
</head>
<body>
	<div>
		<form class="form-signin" action="login" method="post" onSubmit="return check()">
			<h2 class="form-signin-heading">登陆页面</h2>
			<hr>
		    <table>
		            <tr>
	                     <td ></td>	            
		            ...
		            <tr>
		             ...
		             <tr>
	                     <td ></td>	            
		                 <td colspan="2"><label class="checkbox"><input id="remember" name="remember" type="checkbox" value="remember-me">保存密码 &nbsp;&nbsp;&nbsp;&nbsp;  </label></td>
		                 <td></td>	  	  
		            </tr>
		             <tr>
	                     <td ></td>	            
		                 <td><button type="submit"  class="btn btn-primary">登陆</button> <input type="reset" class="btn btn-primary" value="重新输入"/></td>
		                 <td></td>	  	  
		            </tr>
		    </table>
		</form>
